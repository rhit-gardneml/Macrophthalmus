-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\commhdlQPSKTxRx\Compare_To_Constant1_block.vhd
...
ENTITY Compare_To_Constant1_block IS
  PORT( u                                 :   IN    std_logic_vector(5 DOWNTO 0);  -- ufix6
        y                                 :   OUT   std_logic
        );
END Compare_To_Constant1_block;


ARCHITECTURE rtl OF Compare_To_Constant1_block IS
...
BEGIN
  ...
  Constant_out1 <= to_unsigned(16#20#, 6);
