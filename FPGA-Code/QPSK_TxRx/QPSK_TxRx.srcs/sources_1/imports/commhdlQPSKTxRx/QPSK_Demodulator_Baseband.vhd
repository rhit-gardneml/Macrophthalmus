-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\commhdlQPSKTxRx\QPSK_Demodulator_Baseband.vhd
...
-- Source Path: commhdlQPSKTxRx/QPSK Rx/QPSK Demodulator/QPSK Demodulator Baseband
-- Hierarchy Level: 2
-- Model version: 7.26
-- 
-- -------------------------------------------------------------
...
ENTITY QPSK_Demodulator_Baseband IS
...
END QPSK_Demodulator_Baseband;


ARCHITECTURE rtl OF QPSK_Demodulator_Baseband IS

  -- Constants
  CONSTANT DirectLookupTable_data         : vector_of_unsigned2(0 TO 15) := 
    (to_unsigned(16#0#, 2), to_unsigned(16#0#, 2), to_unsigned(16#2#, 2), to_unsigned(16#0#, 2),
     to_unsigned(16#1#, 2), to_unsigned(16#0#, 2), to_unsigned(16#2#, 2), to_unsigned(16#0#, 2),
     to_unsigned(16#1#, 2), to_unsigned(16#3#, 2), to_unsigned(16#3#, 2), to_unsigned(16#0#, 2),
  ...
  SIGNAL out0_vector                      : std_logic_vector(1 DOWNTO 0);  -- boolean [2]
