...
HD_PWD='C:/Users/robinsvs/Documents/Academics/Senior Year/Senior Project/BPSK_modulation/BPSK_modulation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BPSK_Modulation_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BPSK_Modulation_tb.tcl
