SamacSys ECAD Model
225043/1288335/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "MC100EL1648DG" (originalName "MC100EL1648DG")
	...
	(compDef "MC100EL1648DG" (originalName "MC100EL1648DG") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "TANK") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "VCC_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "VCC_2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "OUT") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "BIAS") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "VEE_2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "VEE_1") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "AGC") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MC100EL1648DG"))
		...
		(attr "Manufacturer_Part_Number" "MC100EL1648DG")
		(attr "Mouser Part Number" "863-MC100EL1648DG")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/onsemi/MC100EL1648DG?qs=3JMERSakebqE0DRlvq1XhA%3D%3D")
		(attr "Arrow Part Number" "MC100EL1648DG")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/mc100el1648dg/on-semiconductor")
		(attr "Description" "")
		(attr "Datasheet Link" "http://www.onsemi.com/pub/Collateral/MC100EL1648-D.PDF")
		(attr "Height" "1.75 mm")
	)
